...
public class GRASP_KQBF extends AbstractGRASP<Integer> {
	...
	public static void main(String[] args) throws IOException {
		...
		for(String instancia: instancias) {
			try {
				File myObj = new File("C:\\Users\\rebec\\Documents\\GitHub\\atv4\\GRASP-Framework\\GRASP-Framework\\solutions\\scenario9\\instance_" + instancia + ".txt");
				myObj.createNewFile();
				// Create a FileWriter object
				// to write in the file
				FileWriter fWriter = new FileWriter(
					"C:\\Users\\rebec\\Documents\\GitHub\\atv4\\GRASP-Framework\\GRASP-Framework\\solutions\\scenario9\\instance_" + instancia + ".txt");
